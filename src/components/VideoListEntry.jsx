var VideoListEntry = (props, index) => (
  <div className="video-list-entry media" key={index}>
    <div className="media-left media-middle" >
      <img className="media-object" src={props.snippet.thumbnails.default.url} alt="" />
    </div>
    <div className="media-body">
      <div className="video-list-entry-title" onClick={this.onClick.bind(this)}>{props.snippet.title}</div>
